...
Fits a nonlinear model to estimate recombination rates.
Computes LD decay curves and identifies the half-decay distance.
Visualizes LD decay using scatter plots and fitted curves.
